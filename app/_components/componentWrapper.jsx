    ...
    <>
      ...
      <Tabs defaultValue="component" className="m-auto">
        <TabsList className="mb-4">
          ...
          {!user || (user && user.email !== "ggabi8878@gmail.com") ? (
            <Link
              href="/all-access"
              className="hover:cursor-pointer inline-flex w-6/12 md:w-[45%] mb-5 items-center justify-center whitespace-nowrap px-3 py-3 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:border-b-[1px] border-slate-700"
            >
              <svg
