      ...
      >
        <ul className="list-none gap-2 w-full flex justify-around flex-col items-start pb-2 pl-2 md:pl-0 mb-10 md:flex-row md:justify-center md:items-center md:pt-0 md:h-full md:pb-0">
          ...
          <NavItem
            ...
            text={
              <>
                <span className="text-mainColor dark:text-foreground transition-all duration-300 ease-in-out hover:dark:text-mainColor">
                  Get all access ➜
                </span>
              </>
            }
...
function NavItem({ href, text, key }) {
  return (
    ...
    >
      <Link
        href={href}
        className="text-mainColor dark:text-foreground font-semibold no-underline transition-all duration-300 ease-in-out hover:dark:text-mainColor"
      >
        {text}
      </Link>
    </li>
